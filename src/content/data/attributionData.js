...
export const attributionData = {
      ...
      items: [
        {
          ...
          description:
            "A list of open-source libraries, frameworks, and tools that have been instrumental in the development of Vortex Linux and this website.",
        },
        {
          title: "Icons and Images",
          description:
            "Credits for the icons, images, and graphic assets used on our site, including links to the original sources.",
        },
        {
          title: "Content Contributions",
          description:
            "Acknowledgment of any written content, tutorials, or documentation that has been adapted or directly utilized from external sources.",
        },
      ],
    },
    {
  ...
  attributions: [
    // removed the old icons and replaced them with material design icons
    {
      name: "Icons",
